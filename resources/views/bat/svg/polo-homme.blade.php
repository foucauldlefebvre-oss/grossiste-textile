...
<defs>
    <linearGradient id="sideShadeP" x1="0" y1="0" x2="1" y2="0">
...
{{-- Sleeves --}}
<path d="M155,112 L42,178 L62,238 L155,198 Z" fill="{{ $hexColor }}"/>
<path d="M325,112 L438,178 L418,238 L325,198 Z" fill="{{ $hexColor }}"/>

{{-- Body --}}
<path d="M155,112 L155,462 Q155,490 182,490 L298,490 Q325,490 325,462 L325,112 Z" fill="{{ $hexColor }}"/>
<path d="M155,112 L155,462 Q155,490 182,490 L298,490 Q325,490 325,462 L325,112 Z" fill="url(#sideShadeP)"/>

{{-- Outline --}}
<path d="M155,112 L42,178 L62,238 L155,198 L155,490 L325,490 L325,198 L418,238 L438,178 L325,112"
      fill="none" stroke="rgba(0,0,0,0.2)" stroke-width="1.5"/>

{{-- Polo collar — pointed flaps --}}
<path d="M155,112 Q200,96 240,104 Q280,96 325,112" fill="{{ $hexColor }}"/>
<path d="M190,108 L198,72 L240,88 L282,72 L290,108" fill="{{ $hexColor }}" stroke="rgba(0,0,0,0.18)" stroke-width="1.2"/>
{{-- Collar fold --}}
<line x1="203" y1="80" x2="195" y2="108" stroke="rgba(0,0,0,0.08)" stroke-width="1"/>
<line x1="277" y1="80" x2="285" y2="108" stroke="rgba(0,0,0,0.08)" stroke-width="1"/>

{{-- Button placket --}}
<line x1="240" y1="88" x2="240" y2="185" stroke="rgba(0,0,0,0.08)" stroke-width="1.5"/>
...
{{-- Stitch --}}
<line x1="240" y1="185" x2="240" y2="485" stroke="rgba(0,0,0,0.04)" stroke-width="1" stroke-dasharray="8,6"/>
