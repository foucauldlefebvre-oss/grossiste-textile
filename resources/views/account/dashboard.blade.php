        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="flex-1">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                    ...
                    <a href="{{ route('account.quotes') }}" class="bg-white rounded-xl shadow-sm p-5 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-2xl font-bold text-purple-600">{{ $stats['quotes'] }}</p>
                            </div>
                        </div>
                    </a>
                    <a href="{{ route('account.orders') }}" class="bg-white rounded-xl shadow-sm p-5 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
