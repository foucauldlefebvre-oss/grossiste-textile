    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <x-filament::section>
            <div class="text-center">
                ...
                <div class="text-sm text-gray-500">Produits Imbretex en base</div>
            </div>
        </x-filament::section>
        ...
        <x-filament::section>
            <div class="text-center">
                <div class="text-sm text-gray-500 mb-1">API Imbretex</div>
                <div class="text-xs font-medium font-mono">{{ $this->getTokenStatus() }}</div>
