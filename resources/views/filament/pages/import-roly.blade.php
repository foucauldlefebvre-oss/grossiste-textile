<x-filament-panels::page>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <x-filament::section>
            <div class="text-center">
                ...
                <div class="text-sm text-gray-500">Produits Roly en base</div>
            </div>
        </x-filament::section>
        ...
        <x-filament::section>
            <div class="text-center">
                ...
                <div class="text-sm text-gray-500">Coloris Roly</div>
            </div>
        </x-filament::section>

        <x-filament::section>
            <div class="text-center">
                <div class="text-sm text-gray-500 mb-1">Compte API GorFactory</div>
                <div class="text-base font-medium">{{ $this->getUsername() }}</div>
                <div class="text-xs text-gray-400 mt-1">{{ $this->getApiUrl() }}</div>
            </div>
        </x-filament::section>
    </div>
    ...
    <x-filament::section heading="Actions">
        ...
        {{-- Loading indicator --}}
        <div wire:loading wire:target="testConnection, runImport, runStockUpdate, runDryRun" class="mt-4">
